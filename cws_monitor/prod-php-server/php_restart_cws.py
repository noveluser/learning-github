...
def check_url(port):               #判断URL是否超时，
    ...
    count=1
    cws_status = 0
    api_url="http://127.0.0.1:"+port+"/api/dispdatch/238848/persons?authToken=176ed33052b1fed902319090b27260baa2066cfe%239076&appID=d18b6732881d7e04e665e3eb761861db03b5f06c&secretKey=98da99443c76c483a48904ac70af7c42&agency-id=1"       #检测URL路径
    while count <3 : 
          try:
              start_time=time.time()*1000
	      url_status = requests.get(api_url,timeout=0.002)
    ...
    restart_status=0  #测试语句，用于检查重启模块
